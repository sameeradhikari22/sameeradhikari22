...
class Students():
    def __init__(self, root):
        ...
        title = Label(self.root, text="Student Managment System", bd=10, relief=GROOVE,
        ...
        m_title = Label(Manage_Frame, text="Manage Students", bg="yellow", fg="black",
        ...
        lbl_search = Label(Detials_Frame, text="Details Frame", bg="blue", fg="white",
                           font=("times new roman", 25, "bold"))
        lbl_search.grid(column=2)
    ...
    def add_students(self):
        if self.Roll_No_var.get() == "" or self.name_var.get() == "":
            ...
            con = pymysql.connect(host="localhost", user="root", password="", database="sameer")
            cur = con.cursor()
    ...
    def delete_data(self):
        ...
        messagebox.showinfo("Success", "Recored has been deleted")
